...
#define SA1CheckIRQ()		(SA1Registers.P.B.l & IRQ)
#define SA1CheckDecimal()	(SA1Registers.P.B.l & Decimal)
#define SA1CheckIndex()		(SA1Registers.P.B.l & IndexFlag)
#define SA1CheckMemory()	(SA1Registers.P.B.l & MemoryFlag)
...
#define SA1CheckFlag(f)		(SA1Registers.P.B.l & (f))
